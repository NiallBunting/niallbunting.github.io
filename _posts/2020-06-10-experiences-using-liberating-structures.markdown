...
Liberating structures promise to unleash innovation, creativity and great ideas. Here I capture my thoughts and feelings from my experiences with liberating structures.
...
- Microstructures are the smaller parts such as meeting rooms, brainstorms and discussions. This is where and how discussions take place.
- Structural elements facilitate the microstructures. For example, whiteboards, time allocations and agendas.

All the structures play an important role, as each builds upon the other. Small changes on the lower levels over time can significantly affect the bigger structures. I have noticed for example, that virtual meetings seem to have a smaller pool of ideas and converge to a single idea much faster compared to in person meetings. Possibly, due to the fact virtual meetings only have one person speaking and it can be difficult to edge in. This reduces the pool of ideas and the best idea may not be chosen.

It's important to note that each level of the structures listed above includes both tangible and intangible elements. Liberating structures are specifically different ways to have a meeting/discussion/report. This puts them in the category of intangible microstructures.
...
_List of the structures taken from - [Liberating Structures][liberatingstructures]_

## The Experiences

This post will be updated as I use more of the structures, and if my views of the structures significantly change as I gain more experience with them.
...
<ul>
  ...
  <div class="details-inner">
   ...
   The rules for this structure were easy to follow and not overly prescriptive in their method.
   </p> <p>
   It was good to put down in words some of these paradoxical challenges the team faces, even though some are obvious to many team members. None of the generated questions particularly stood out as groundbreaking. A couple were a little one-sided, but overall it was a good mix.
   </p> <p>
   I found it difficult to build upon the wicked questions proposed back to the entire group; however, we came together to find an overall wicked question that covered the major aspects of other questions that were proposed.
   </p> <p>
