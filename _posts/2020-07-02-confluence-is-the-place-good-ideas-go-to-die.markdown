...
Long form documentation is great for certain types of information, such as overviews of projects. For other information types they are not optimal, they are especially bad for quick questions as they are prone to having too much irrelevant (for the asker) information in them ([see post on JIT knowledge][jitknowledge]). There are many document formats, each with their specific advantages. Checklists are great for allowing people to go through a process, in a repeatable manner. Q&A is great because it frames the question from the asker's point of view.
